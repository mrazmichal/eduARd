Web application for authoring of AR content. The AR scenes can be anchored either to a GPS position or to a marker. The scenes can contain 3D models, animations, model parts, annotations, and events.
